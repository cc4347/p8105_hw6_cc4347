...
As can be expected because their disributions are unique, the calculated quantiles differ, and the Log(B0*B1) plot has higher quantiles since its distribution is centered around a higher value.